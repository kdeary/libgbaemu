...
struct debugger {
    /* Placeholder when debugger support is disabled. */
};

struct gba;

static inline void debugger_init(struct debugger *debugger __unused) {}
static inline void debugger_eval_breakpoints(struct gba *gba __unused) {}
static inline void debugger_eval_write_watchpoints(struct gba *gba __unused, uint32_t addr __unused, size_t size __unused, uint32_t value __unused) {}
static inline void debugger_eval_read_watchpoints(struct gba *gba __unused, uint32_t addr __unused, size_t size __unused) {}
static inline void debugger_execute_run_mode(struct gba *gba __unused) {}
